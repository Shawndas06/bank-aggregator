...
### 📚 Где посмотреть все API роуты:

1. **Swagger UI (ОТКРОЙТЕ ЭТО!)** - http://localhost:8000/docs
   - Все 26 эндпоинтов с описанием
   - Можно тестировать запросы прямо в браузере
   - Примеры request/response

2. **API_DOCUMENTATION.md** - Полная документация с примерами кода для React/TypeScript

3. **Код роутов** - `src/routers/` (auth.py, accounts.py, groups.py)
...
**Swagger UI:** http://localhost:8000/docs ← **ОТКРОЙТЕ ЭТО**  
